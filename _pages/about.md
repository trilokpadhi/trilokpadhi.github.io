...
I am a fifth-year PhD student in Computer Science at [Georgia State University](https://www.gsu.edu/), advised by [Prof. Ugur Kursuncu](https://www.ugurkursuncu.com/) in the [SWAN AI Research Group](https://www.ugurkursuncu.com/SWAN-AI/). My research focuses on making multimodal models and agents safer in real-world settings by improving their **grounding, interpretability, and trustworthiness**. Large vision-language models can describe images and act in the world, but they can still be confidently wrong in unpredictable ways and may fail midway through long-horizon tasks without signaling it. My work addresses these challenges through three core threads:

- **Interpretability, uncertainty quantification, and control.** I study how to read an LLM agent’s internal state step by step so failures can be detected before a trajectory ends, and how to align stated confidence with verifiable visual evidence.
- **Knowledge-enhanced multimodal learning.** I integrate commonsense and structured knowledge to design compact vision-language models (< 1B) that can perform at par with Large Vision Language models (LVLMs) while being more interpretable and controllable.
- **Safety and social impact.** Red-teaming vision-language models and agents under realistic, multi-turn adversarial pressure, including harassment, toxicity, and manipulation. I also study LLM behavior in sensitive settings such as anxiety support.
