...
I am a fifth-year PhD student in Computer Science at [Georgia State University](https://www.gsu.edu/), advised by [Prof. Ugur Kursuncu](https://www.ugurkursuncu.com/) in the [SWAN AI Research Group](https://www.ugurkursuncu.com/SWAN-AI/). My research focuses on making multimodal models and agents safer in real-world settings by improving their **grounding, interpretability, and trustworthiness**. Large vision-language models can describe images and act in the world, but they can still be confidently wrong in unpredictable ways and may fail midway through long-horizon tasks. My work addresses these challenges of Multimodal Language Models & Agents by asking the following questions:

- **Reliability : Interpretability, uncertainty quantification, and control.** How can we read an LLM agent’s internal state step by step so failures can be detected before a trajectory ends, and how to align stated confidence with verifiable visual evidence.
- **Knowledge-enhanced multimodal learning.** How can we integrate commonsense and structured knowledge to design compact vision-language models (< 1B) that can perform at par with Large Vision Language models (LVLMs) while being more interpretable and controllable.
- **Safety and social impact.** How can we red-team vision-language models and agents under realistic, multi-turn adversarial pressure, including harassment, toxicity, and manipulation? How do LLMs behave in sensitive settings such as anxiety support?
